(ns ped-geschichte.html-templates
  (:use [io.pedestal.app.templates :only [tfn dtfn tnodes]]))

(defmacro ped-geschichte-templates
  []
  ;; Extract the 'hello' template from the template file ped-geschichte.html.
  ...
  {:ped-geschichte-page (dtfn (tnodes "ped-geschichte.html" "hello") #{:id})})
